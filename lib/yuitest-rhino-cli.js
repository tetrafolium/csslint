    ...
    keys:
        ...
        function(obj) {
            ...
            if (YUITest.Object._hasEnumBug) {
                for (
                    i = 0, len = YUITest.Object._forceEnum.length;
                    i < len;
                    ++i
                ) {
...
YUITest.Util.mix(YUITest.CLI, {
    ...
    options: { verbose: false, webcompat: false, help: false, format: "xunit" },
