...
YUITest.EventTarget.prototype = {
   ...
   * @deprecated
   */
  subscribe : function(type, listener) { this.attach.apply(this, arguments); },
   ...
   * @deprecated
   */
  unsubscribe : function(type, listener) { this.detach.apply(this, arguments); }
...
YUITest.AssertionError.prototype = {
   ...
   */
  toString : function() { return this.name + ": " + this.getMessage(); }
...
YUITest.ShouldError = function(message) {
  ...
  YUITest.AssertionError.call(
      this, message || "This test should have thrown an error but didn't.");
...
YUITest.ShouldFail = function(message) {
  // call superclass
  YUITest.AssertionError.call(this,
 ...
 * @param {int} delay The number of milliseconds to wait before running the
 *     code.
 * @class Wait
 * @namespace Test
 * @constructor
...
YUITest.Assert = {
   ...
   * @static
   */
  _getCount : function() { return this._asserts; },
   ...
   * @static
   */
  _increment : function() { this._asserts++; },
   ...
   * @static
   */
  _reset : function() { this._asserts = 0; },
  ...
  /**
   * Asserts that a value is not equal to another. This uses the double equals
   * sign so type cohersion may occur.
   * @param {Object} unexpected The unexpected value.
   * @param {Object} actual The actual value to test.
   * @param {String} message (Optional) The message to display if the assertion
   *     fails.
  ...
  /**
   * Asserts that a value is not the same as another. This uses the triple
   * equals sign so no type cohersion may occur.
   * @param {Object} unexpected The unexpected value.
   * @param {Object} actual The actual value to test.
   * @param {String} message (Optional) The message to display if the assertion
   *     fails.
  ...
  /**
   * Asserts that a value is the same as another. This uses the triple equals
  ...
  isTrue : function(actual, message) {
    ...
    if (true !== actual) {
      throw new YUITest.ComparisonFailure(
          YUITest.Assert._formatMessage(message, "Value should be true."), true,
          actual);
    }
  },
  ...
  isNaN : function(actual, message) {
    ...
    if (!isNaN(actual)) {
      throw new YUITest.ComparisonFailure(
          YUITest.Assert._formatMessage(message, "Value should be NaN."), NaN,
          actual);
    }
  },
  ...
  isNull : function(actual, message) {
    ...
    if (actual !== null) {
      throw new YUITest.ComparisonFailure(
          YUITest.Assert._formatMessage(message, "Value should be null."), null,
          actual);
    }
  },
   ...
   * @param {Function} expected The function that the object should be an
   *     instance of.
    ...
    if (!(actual instanceof expected)) {
      throw new YUITest.ComparisonFailure(
          YUITest.Assert._formatMessage(
              message, "Value isn't an instance of expected type."),
          expected, actual);
    }
  },
  ...
  isTypeOf : function(expectedType, actualValue, message) {
    ...
    if (typeof actualValue != expectedType) {
      throw new YUITest.ComparisonFailure(
          YUITest.Assert._formatMessage(message, "Value should be of type " +
                                                     expectedType + "."),
          expectedType, typeof actualValue);
    }
  },
  ...
  throwsError : function(expectedError, method, message) {
    ...
    throw new YUITest.AssertionError(YUITest.Assert._formatMessage(
...
YUITest.ArrayAssert = {
  ...
  contains : function(needle, haystack, message) {
    ...
    if (this._indexOf(haystack, needle) == -1) {
      YUITest.Assert.fail(YUITest.Assert._formatMessage(
          message, "Value " + needle + " (" + (typeof needle) +
                       ") not found in array [" + haystack + "]."));
    }
  },

  /**
   * Asserts that a set of values are present in an array. This uses the triple
   * equals sign so no type cohersion may occur. For this assertion to pass, all
   * values must be found.
   * @param {Object[]} needles An array of values that are expected in the
   *     array.
  ...
  containsItems : function(needles, haystack, message) {
    ...
    for (var i = 0; i < needles.length; i++) {
      if (this._indexOf(haystack, needles[i]) == -1) {
        YUITest.Assert.fail(YUITest.Assert._formatMessage(
            message, "Value " + needles[i] + " (" + (typeof needles[i]) +
                         ") not found in array [" + haystack + "]."));
      }
    }
  },
  ...
  /**
   * Asserts that a value matching some condition is present in an array. This
   * uses a function to determine a match.
   * @param {Function} matcher A function that returns true if the items matches
   *     or false if not.
   * @param {Array} haystack An array of values.
   * @param {String} message (Optional) The message to display if the assertion
   *     fails.
  ...
  containsMatch : function(matcher, haystack, message) {
    ...
    if (!this._some(haystack, matcher)) {
      YUITest.Assert.fail(YUITest.Assert._formatMessage(
          message, "No match found in array [" + haystack + "]."));
    }
  },

  /**
   * Asserts that a value is not present in an array. This uses the triple
   * equals Asserts that a value is not present in an array. This uses the
   * triple equals sign so no type cohersion may occur.
   * @param {Object} needle The value that is expected in the array.
   * @param {Array} haystack An array of values.
   * @param {String} message (Optional) The message to display if the assertion
   *     fails.
  ...
  doesNotContain : function(needle, haystack, message) {
    ...
    if (this._indexOf(haystack, needle) > -1) {
      YUITest.Assert.fail(YUITest.Assert._formatMessage(
          message, "Value found in array [" + haystack + "]."));
    }
  },

  /**
   * Asserts that a set of values are not present in an array. This uses the
   * triple equals sign so no type cohersion may occur. For this assertion to
   * pass, all values must not be found.
   * @param {Object[]} needles An array of values that are not expected in the
   *     array.
   * @param {Array} haystack An array of values to check.
   * @param {String} message (Optional) The message to display if the assertion
   *     fails.
  ...
  /**
   * Asserts that no values matching a condition are present in an array. This
   * uses a function to determine a match.
   * @param {Function} matcher A function that returns true if the item matches
   *     or false if not.
   * @param {Array} haystack An array of values.
   * @param {String} message (Optional) The message to display if the assertion
   *     fails.
  ...
  /**
   * Asserts that the given value is contained in an array at the specified
   * index. This uses the triple equals sign so no type cohersion will occur.
  ...
  indexOf : function(needle, haystack, index, message) {
    ...
    YUITest.Assert.fail(YUITest.Assert._formatMessage(
        message, "Value doesn't exist in array [" + haystack + "]."));
  },
  ...
  itemsAreEqual : function(expected, actual, message) {
    ...
    if (expected.length != actual.length) {
      YUITest.Assert.fail(YUITest.Assert._formatMessage(
          message, "Array should have a length of " + expected.length +
                       " but has a length of " + actual.length));
    }
    ...
    for (var i = 0; i < expected.length; i++) {
      if (expected[i] != actual[i]) {
        throw new YUITest.Assert.ComparisonFailure(
            YUITest.Assert._formatMessage(message, "Values in position " + i +
                                                       " are not equal."),
            expected[i], actual[i]);
      }
    }
  ...
  /**
   * Asserts that the values in an array are equivalent, and in the same
   * position, as values in another array. This uses a function to determine if
   * the values are equivalent. Note that the array objects themselves need not
   * be the same for this test to pass.
   * @param {Array} expected An array of the expected values.
   * @param {Array} actual Any array of the actual values.
  ...
  /**
   * Asserts that the given value is contained in an array at the specified
   * index, starting from the back of the array. This uses the triple equals
   * sign so no type cohersion will occur.
   * @param {Object} needle The value to look for.
   * @param {Array} haystack The array to search in.
   * @param {int} index The index at which the value should exist.
   * @param {String} message (Optional) The message to display if the assertion
  ...
  lastIndexOf : function(needle, haystack, index, message) {
    ...
    // if it makes it here, it wasn't found at all
    YUITest.Assert.fail(YUITest.Assert._formatMessage(
        message, "Value doesn't exist in array."));
  }
...
YUITest.ObjectAssert = {
   ...
   * @param {Object} expected The object with all expected properties and
   *     values.
    ...
    for (var name in expected) {
      if (expected.hasOwnProperty(name)) {
        if (expected[name] != actual[name]) {
          throw new YUITest.ComparisonFailure(
              YUITest.Assert._formatMessage(
                  message, "Values should be equal for property " + name),
   ...
   * @param {Array} properties An array of property names that should be on the
   *     object.
   * @param {Object} object The object to search.
   * @param {String} message (Optional) The message to display if the assertion
   *     fails.
  ...
  /**
   * Asserts that a property with the given name exists on an object's
   * prototype.
   * @param {String} propertyName The name of the property to test.
   * @param {Object} object The object to search.
   * @param {String} message (Optional) The message to display if the assertion
  ...
  /**
   * Asserts that all properties exist on an object instance (not on its
   * prototype).
   * @param {Array} properties An array of property names that should be on the
   *     object.
   * @param {Object} object The object to search.
  ...
  ownsOrInheritsKeys : function(properties, object, message) {
    ...
    for (var i = 0; i < properties.length; i++) {
      if (!(properties[i] in object)) {
        YUITest.Assert.fail(YUITest.Assert._formatMessage(
            message, "Property '" + properties[i] + "' not found on object."));
      }
    }
  }
};
...
YUITest.DateAssert = {
  ...
  datesAreEqual : function(expected, actual, message) {
    ...
    if (expected instanceof Date && actual instanceof Date) {
      ...
      if (msg.length) {
        throw new YUITest.ComparisonFailure(
            YUITest.Assert._formatMessage(message, msg), expected, actual);
      }
    } else {
      throw new TypeError(
  ...
  /**
   * Asserts that a date's hour, minutes, and seconds are equal to another
   * date's.
   * @param {Date} expected The expected date.
   * @param {Date} actual The actual date to test.
   * @param {String} message (Optional) The message to display if the assertion
    ...
    if (template.hasOwnProperty(name)) {
      if (typeof template[name] == "function") {
        mock[name] = function(name) {
          return function() {
            YUITest.Assert.fail("Method " + name +
                                "() was called but was not expected to be.");
          };
        }(name);
      }
    }
...
YUITest.Mock.expect = function(mock /*:Object*/, expectation /*:Object*/) {
  ...
  if (expectation.method) {
    var name = expectation.method, args = expectation.args || [],
        result = expectation.returns,
        callCount = (typeof expectation.callCount == "number")
                        ? expectation.callCount
                        : 1,
        error = expectation.error, run = expectation.run || function() {}, i;
    ...
    for (i = 0; i < args.length; i++) {
      if (!(args[i] instanceof YUITest.Mock.Value)) {
        args[i] = YUITest.Mock.Value(YUITest.Assert.areSame, [ args[i] ],
                                     "Argument " + i + " of " + name +
                                         "() is incorrect.");
      }
    }
  ...
  try {
    ...
    for (var name in mock.__expectations) {
      if (mock.__expectations.hasOwnProperty(name)) {
        ...
        if (expectation.method) {
          YUITest.Assert.areEqual(
              expectation.callCount, expectation.actualCallCount,
              "Method " + expectation.method +
                  "() wasn't called the expected number of times.");
        } else if (expectation.property) {
          YUITest.Assert.areEqual(expectation.value, mock[expectation.property],
 ...
 * @param {Array} originalArgs (Optional) Array of arguments to pass to the
 *     method.
 ...
 * @param template An object containing any number of test methods, other
 *     methods,
...
YUITest.TestCase.prototype = {
   ...
   * @method resume
   */
  resume : function(segment) { YUITest.TestRunner.resume(segment); },
   ...
   * @param {int} delay (Optional) The number of milliseconds to wait before
   *     running
  ...
  /**
   * Asserts that a given condition is true. If not, then a
   * YUITest.AssertionError object is thrown and the test fails.
   * @method assert
   ...
   * @param {String} message (Optional) The message to display with the failure.
   */
  fail: function(message) { YUITest.Assert.fail(message); },
 ...
 * @param {String||Object} data The name of the test suite or an object
 *     containing
...
YUITest.TestSuite.prototype = {
   ...
   * @param {YUITest.TestSuite||YUITest.TestCase} testObject The test suite or
   *     test case to add.
   * @return {Void}
   * @method add
   */
  add : function(testObject) {
    if (testObject instanceof YUITest.TestSuite || testObject instanceof
                                                       YUITest.TestCase) {
...
YUITest.TestFormat = function() {
  ...
  return {
     ...
     * @static
     */
    JSON : function(results) { return YUITest.Util.JSON.stringify(results); },
    ...
    XML : function(results) {
      function serializeToXML(results) {
        ...
        if (results.type == "test") {
          xml += " result=\"" + results.result + "\" message=\"" +
                 xmlEscape(results.message) + "\">";
        } else {
          xml += " passed=\"" + results.passed + "\" failed=\"" +
                 results.failed + "\" ignored=\"" + results.ignored +
                 "\" total=\"" + results.total + "\">";
          for (var prop in results) {
            if (results.hasOwnProperty(prop)) {
              if (results[prop] && typeof results[prop] == "object" &&
    ...
    JUnitXML : function(results) {
      function serializeToJUnitXML(results) {
        ...
        case "test":
          if (results.result != "ignore") {
            xml = "<testcase name=\"" + xmlEscape(results.name) + "\" time=\"" +
                  (results.duration / 1000) + "\">";
            if (results.result == "fail") {
              xml += "<failure message=\"" + xmlEscape(results.message) +
                     "\"><![CDATA[" + results.message + "]]></failure>";
            }
            xml += "</testcase>";
          }
          break;
        ...
        case "testcase":
          ...
          xml = "<testsuite name=\"" + xmlEscape(results.name) + "\" tests=\"" +
                results.total + "\" failures=\"" + results.failed +
      ...
      return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
             serializeToJUnitXML(results);
    },

    /**
     * Returns test results formatted in TAP format.
     * For more information, see <a href="http://testanything.org/">Test
     * Anything Protocol</a>.
     * @param {Object} result The results object created by TestRunner.
    ...
    TAP : function(results) {
      ...
      function serializeToTAP(results) {
        ...
        case "testcase":
          ...
          text = "#Begin testcase " + results.name + "(" + results.failed +
                 " failed of " + results.total + ")\n";
        ...
        case "testsuite":
          ...
          text = "#Begin testsuite " + results.name + "(" + results.failed +
                 " failed of " + results.total + ")\n";
...
YUITest.CoverageFormat = {
   ...
   */
  JSON : function(coverage) { return YUITest.Util.JSON.stringify(coverage); },

  /**
   * Returns the coverage report in a JSON format compatible with
   * Xdebug. See <a href="http://www.xdebug.com/docs/code_coverage">Xdebug
   * Documentation</a> for more information. Note: function coverage is not
...
YUITest.Event = (function() {
  var
      ...
      keyEvents = {keydown : 1, keyup : 1, keypress : 1},

      // HTML events supported
      uiEvents =
          {blur : 1, change : 1, focus : 1, resize : 1, scroll : 1, select : 1},
  ...
  function simulateKeyEvent(
      target /*:HTMLElement*/, type /*:String*/, bubbles /*:Boolean*/,
      cancelable /*:Boolean*/, view /*:Window*/, ctrlKey /*:Boolean*/,
      ...
      relatedTarget /*:HTMLElement*/) /*:Void*/
  {
    ...
    if (typeof cancelable != "boolean") {
      cancelable =
          (type !=
           "mousemove"); // mousemove is the only one that can't be cancelled
    }
    if (typeof view != "object" || view != null) {
      view = window; // view is typically window
    }
                           ...
                           view /*:Window*/, detail /*:int*/) /*:Void*/
  {
    ...
    if (typeof type == "string") {
      ...
      // make sure it's a supported mouse event
      if (!uiEvents[type]) {
        throw new Error("simulateUIEvent(): Event type '" + type +
                        "' not supported.");
      }
    } else {
    ...
    if (typeof cancelable != "boolean") {
      cancelable =
          (type == "submit"); // submit is the only one that can be cancelled
    }
    if (typeof view != "object" || view != null) {
      view = window; // view is typically window
    }
  ...
  object = {
     ...
     * @param {HTMLElement} target The DOM element that's the target of the
     *     event.
     * @param {String} type The type of event to simulate (i.e., "click").
     * @param {Object} options (Optional) Extra options to copy onto the event
     *     object.
     * @return {void}
     * @method simulate
     * @static
    ...
    simulate : function(target, type, options) {
      ...
      if (mouseEvents[type]) {
        simulateMouseEvent(
            target, type, options.bubbles, options.cancelable, options.view,
        ...
        simulateKeyEvent(target, type, options.bubbles, options.cancelable,
                         options.view, options.ctrlKey, options.altKey,
                         options.shiftKey, options.metaKey, options.keyCode,
                         options.charCode);
      } else if (uiEvents[type]) {
        simulateUIEvent(target, type, options.bubbles, options.cancelable,
    ...
    if (mouseEvents.hasOwnProperty(prop)) {
      object[prop] = (function(type) {
        return function(target, options) {
          options = options || {};
          simulateMouseEvent(target, type, options.bubbles, options.cancelable,
                             options.view, options.detail, options.screenX,
                             options.screenY, options.clientX, options.clientY,
                             options.ctrlKey, options.altKey, options.shiftKey,
                             options.metaKey, options.button,
 ...
 * @param {Function} format (Optiona) A function that outputs the results in a
 *     specific format.
...
YUITest.Reporter.prototype = {
   ...
   * @method addField
   */
  addField : function(name, value) { this._fields[name] = value; },
   ...
   * @method addField
   */
  clearFields : function() { this._fields = new Object(); },

  /**
   * Cleans up the memory associated with the TestReporter, removing DOM
  ...
  report : function(results) {
    ...
    if (!this._form) {
      ...
      try {
        this._iframe =
            document.createElement("<iframe name=\"yuiTestTarget\" />");
      } catch (ex) {
...
YUITest.PageManager = YUITest.Util.mix(new YUITest.EventTarget(), {
  ...
  _handleTestRunnerComplete : function(data /*:Object*/) /*:Void*/ {
    this.fire(this.TEST_PAGE_COMPLETE_EVENT,
              {page : this._curPage, results : data.results});
    ...
    if (this._pages.length) {
      this._timeoutId =
          setTimeout(function() { YUITest.TestManager._run(); }, 1000);
    } else {
  ...
  load : function() /*:Void*/ {
    if (parent.YUITest.PageManager !== this) {
      ...
      if (this._frame) {
        ...
        TestRunner.subscribe(TestRunner.COMPLETE_EVENT,
                             this._handleTestRunnerComplete, this, true);
   ...
   * @static
   */
  setPages : function(pages /*:String[]*/) /*:Void*/ { this._pages = pages; },
   ...
   * @static
   */
  stop : function() /*:Void*/ { clearTimeout(this._timeoutId); }
...
YUITest.TestRunner = function() {
   ...
   * test function.
   * @param {Variant} testObject A TestSuite, TestCase, or the name of a test
   *     function.
   * @class TestNode
   * @constructor
   * @private
  ...
  TestNode.prototype = {
    ...
    /**
     * Appends a new test object (TestSuite, TestCase, or test function name) as
  ...
  function TestRunner() {
     ...
     */
    this.masterSuite =
        new YUITest.TestSuite("yuitests" + (new Date()).getTime());
  ...
  TestRunner.prototype = YUITest.Util.mix(new YUITest.EventTarget(), {
    ...
    _addTestCaseToTestTree : function(parentNode, testCase) {
      ...
      for (prop in testCase) {
        if ((prop.indexOf("test") === 0 || prop.indexOf(" ") > -1) &&
     ...
     * @param {TestNode} parentNode The node to add the test suite to as a
     *     child.
    ...
    /**
     * Builds the test tree based on items in the master suite. The tree is a
     * hierarchical representation of the test suites, test cases, and test
     * functions. The resulting tree is stored in _root and the pointer _cur is
     * set to the root initially.
     * @return {Void}
     * @static
     * @private
     ...
     * @return {TestNode} The next node in the test tree or null if the end is
     *     reached.
     * @private
     * @static
     * @method _next
     ...
     * @param {Boolean} allowAsync Determines if the method can be called
     *     asynchronously.
    ...
    _execNonTestMethod : function(node, methodName, allowAsync) {
      var testObject = node.testObject, event = {type : this.ERROR_EVENT};
      try {
     ...
     * @param {YUITest.TestCase|YUITest.TestSuite} testObject The test case or
     *     test suite to run.
     * @return {Object} Results of the execution with properties passed, failed,
     *     and total.
     * @private
     * @method _run
     * @static
    ...
    _run : function() {
      ...
      if (node !== null) {
        ...
        if (typeof testObject == "object" && testObject !== null) {
          if (testObject instanceof YUITest.TestSuite) {
            this.fire(
                {type : this.TEST_SUITE_BEGIN_EVENT, testSuite : testObject});
            node._start = new Date();
            this._execNonTestMethod(node, "setUp", false);
          } else if (testObject instanceof YUITest.TestCase) {
            this.fire(
                {type : this.TEST_CASE_BEGIN_EVENT, testCase : testObject});
            node._start = new Date();
            ...
            /*try {
                ...
                node.results.errors++;
                this.fire({ type: this.ERROR_EVENT, error: ex, testCase:
            testObject, methodName: "init" });
            }*/
          ...
          if (typeof setTimeout != "undefined") {
            setTimeout(function() { YUITest.TestRunner._run(); }, 0);
          } else {
            this._run();
          }
        } else {
    ...
    _resumeTest : function(segment) {
      ...
      if (!node) {
        ...
        // this.fire("error", { testCase: "(unknown)", test: "(unknown)", error:
        // new Error("wait() called after resume()")} );
        return;
      }
      ...
      try {
        ...
        // if it should fail, and it got here, then it's a fail because it
        // didn't
        else if (shouldFail) {
    ...
    _handleError : function(error) {
      if (this._waiting) {
        this._resumeTest(function() { throw error; });
      } else {
        throw error;
      }
    },
    ...
    _runTest : function(node) {
      // get relevant information
      var testName = node.testObject, testCase = node.parent.testObject,
      ...
      if (shouldIgnore) {
        ...
        node.parent.results[testName] = {
          ...
          type : "test",
          name : testName.indexOf("ignore:") === 0 ? testName.substring(7)
                                                   : testName
        };
     ...
     * @method getName
     */
    getName : function() { return this.masterSuite.name; },
     ...
     * @method setName
     */
    setName : function(name) { this.masterSuite.name = name; },
     ...
     * @static
     */
    isWaiting : function() { return this._waiting; },
    ...
    /**
     * Returns the last complete results set from the TestRunner. Null is
     * returned if the TestRunner is running or no tests have been run.
     * @param {Function} format (Optional) A test format to return the results
     *     in.
     * @return {Object|String} Either the results object or, if a test format is
     *      passed as the argument, a string representing the results in a
     * specific format.
     * @method getResults
     */
     ...
     * in the same pass.
     * @param {Function} format (Optional) A coverage format to return results
     *     in.
     * @return {Object|String} Either the coverage object or, if a coverage
     *      format is specified, a string representing the results in that
     * format.
     * @method getCoverage
     */
     ...
     */
    callback : function() {
      var names = arguments, data = this._context, that = this;
     ...
     *      <code>oldMode</code> indicates the TestRunner should work in the YUI
     * <= 2.8 way of internally managing test suites. <code>groups</code> is an
     * array of test groups indicating which tests to run.
     * @return {Void}
     * @method run
     * @static
     */
    run : function(options) {
      ...
      var runner = YUITest.TestRunner, oldMode = options.oldMode;

      // if there's only one suite on the masterSuite, move it up
      if (!oldMode && this.masterSuite.items.length == 1 &&
          this.masterSuite.items[0] instanceof YUITest.TestSuite) {
        this.masterSuite = this.masterSuite.items[0];
      }

      // determine if there are any groups to filter on
      runner._groups = (options.groups instanceof Array)
                           ? "," + options.groups.join(",") + ","
                           : "";
